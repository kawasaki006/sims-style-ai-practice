...
public class TraitElement
{
    ...
    [Range(.5f, 1.5f)][FormerlySerializedAs("PositiveScale")] public float Scoring_PositiveScale = 1f;
    [Range(.5f, 1.5f)][FormerlySerializedAs("NegativeScale")] public float Scoring_NegativeScale = 1f;

    [Header("Impact Scales")]
    [Range(.5f, 1.5f)] public float Impact_PositiveScale = 1f;
    [Range(.5f, 1.5f)] public float Impact_NegativeScale = 1f;

    [Header("Decay Rate")]
    [Range(.5f, 1.5f)] public float DecayRateScale = 1f;
